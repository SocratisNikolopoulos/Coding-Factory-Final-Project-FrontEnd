 ...
 *
 * This component represents the layout structure for the dashboard section of the application.
 * It includes the header, main content area (rendered by the Outlet from React Router),
 * and a footer specific to the dashboard.
 *
 * Components:
 * - DashHeader: Component rendering the header for the dashboard
 * - DashFooter: Component rendering the footer for the dashboard
